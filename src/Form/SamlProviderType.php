    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('spEntityId', UrlType::class, [
                'label' => 'SP Entity ID',
                'attr'  => ['placeholder' => 'https://dashddi.goshen.edu/saml/metadata'],
            ])
            ->add('spAcsUrl', UrlType::class, [
                'label' => 'SP Assertion Consumer Service URL',
                'attr'  => ['placeholder' => 'https://dashddi.goshen.edu/saml/acs'],
            ])
            ->add('spSloUrl', UrlType::class, [
                'label' => 'SP Single Logout URL',
                'attr'  => ['placeholder' => 'https://dashddi.goshen.edu/saml/logout'],
            ])
