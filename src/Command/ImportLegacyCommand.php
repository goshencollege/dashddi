...
class ImportLegacyCommand extends Command
{
    ...
    private function seedDomainRecords(SymfonyStyle $io, bool $dryRun): void
    {
        ...
        $defs = [
            ...
            ["goshen.edu", "dns1", "A", "192.168.60.20", 28800, "db.goshen.edu.internal.footer content", ["internal"]],
            ["goshen.edu", "dns2", "A", "192.168.60.21", 28800, "db.goshen.edu.internal.footer content", ["internal"]],
            ["goshen.edu", "dns3", "A", "192.168.60.22", 28800, "db.goshen.edu.internal.footer content", ["internal"]],
            ...
            ["goshen.edu", "dns1", "AAAA", "2001:18e8:408:3c::14", 28800, null, ["internal"]],
            ["goshen.edu", "dns2", "AAAA", "2001:18e8:408:3c::15", 28800, null, ["internal"]],
            ["goshen.edu", "dns3", "AAAA", "2001:18e8:408:3c::16", 28800, null, ["internal"]],
