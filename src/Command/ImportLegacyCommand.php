...
class ImportLegacyCommand extends Command
{
    ...
    private function seedDomainRecords(SymfonyStyle $io, bool $dryRun): void
    {
        ...
        $defs = [
            ...
            ["goshen.edu", "M1._domainkey", "TXT", "k=rsa; p=MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDFUlNZvtGDlIGDRtzyRQydM9yRInD5YMx86QpgZ3v7pT+Mx4tGbjUxY41TXbsp7UH9hTREaKKGQKNM/B3FzcFVv4zafZ09lUaXcbSdtD70iXyH0OXEGXLZI5gG0ZwjK5ptgQ18d+pUP9s8xMkJnZlubTk9MLvQnv3ZBzoL9FHFDQIDAQAB", "Marketo domain key", ["external", "internal"]],
